...
def fetch_campaigns(
    ...
    """
    Fetch campaigns across configured ad accounts.

    Args:
        effective_statuses: optional list to filter campaigns (e.g. ["ACTIVE", "PAUSED"])
    """
        ...
        with ThreadPoolExecutor(max_workers=workers) as pool:
            ...
            for fut in as_completed(futures):
                try:
                    ...
                    raise GraphAPIError(f"Campaigns fetch failed for {futures[fut]}: {e}") from e
